...
const argv = Yargs(hideBin(process.argv))
  ...
  .epilogue('A database will be loaded from current directory, if one exists. You can override this by specifying a path to the directory with db.sqlite3 and key_x25519 files in BUNSOGS_DIR environment variable.')
  .locale('en')
  .wrap(120)
  .parse()
